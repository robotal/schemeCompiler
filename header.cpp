...
// int main(){
//
//     const char* foo = "solution";
//     u64 ptr = (u64) foo;
//     printf("foo size: %li ptr size: %lu, ptr val: %llx\n", sizeof(foo), sizeof(ptr), ptr);
//     printf("7ULL: %llx\n", 7ULL);
//     printf("7ULL^MASK64 = %llx\n", 7ULL^MASK64);
//     u64 mystr = ENCODE_STR(foo);
//     printf("%llx | 7 = %llx\n", ptr, mystr);
//     const char* foo2 = DECODE_STR(mystr);
//
//     printf("new pointer: %llx\n", (u64) foo2);
//
//     prim_print_aux (mystr);
//     printf("\nString is: %s\n",foo2);
//     return 0;
// }
//func is a function pointer in our language which takes an environment
//  and a list of arguments
//envList is a list of environmental variables we need to bind in our vector)
}
